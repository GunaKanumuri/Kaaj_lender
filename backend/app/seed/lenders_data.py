...
#
# TABLE OF CONTENTS
#   1.  Shared Constants     — excluded state/industry/equipment lists
#   2.  Stearns Bank         — 9 programs: Full Credit, Corp Only, PayNet Only
#   3.  Apex Commercial      — 7 programs: A+/A/B/C, Medical A/B, Corp Only
#   4.  Advantage+ Financing — 2 programs: Standard, Startup
#   5.  Citizens Bank        — 4 programs: Tier 1/2, Non-Homeowner, Tier 3
#   6.  Falcon Equipment     — 3 programs: A/B Standard, A/B Trucking, C/D/E
#   7.  LENDERS_SEED         — final exported list
# ============================================================


# region ── 1. Shared Constants ───────────────────────────────
#
# Reused across multiple lenders to avoid duplication and
# ensure consistent exclusion lists when rules are seeded.
# ─────────────────────────────────────────────────────────────
...
# region ── 3. Apex Commercial Capital ────────────────────────
#
    ...
    "programs": [
        {
            ...
            "rules": [
                ...
                {"field": "time_in_business_years",  "operator": "gte",     "value_numeric": 7,     "rule_type": "soft", "label": "Prefer 7yr Trade History",         "score_weight": 8},  # FIX-4b
            ],
        },
        {
...
# region ── 6. Falcon Equipment Finance ───────────────────────
#
...
# region ── 7. LENDERS_SEED ────────────────────────────────────
#
# Final exported list consumed by app/db/seed.py.
# Order here determines seeding order — does not affect matching.
# ─────────────────────────────────────────────────────────────
